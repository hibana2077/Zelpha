#!/usr/bin/env python3
"""
Generate PBS job scripts for HL50MBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: HL50MBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# HL50MBK Parameter Sweep Experiments

## Overview
This document tracks all HL50MBK parameter sweep experiments.
...
""".format(datetime.date.today().isoformat())
    ...
    with open("HL50MBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: HL50MBK_experiments.md")
...
echo "Submitting {} HL50MBK experiments..."
echo ""
