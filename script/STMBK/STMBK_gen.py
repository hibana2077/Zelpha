#!/usr/bin/env python3
"""
Generate PBS job scripts for STMBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: STMBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# STMBK Parameter Sweep Experiments

## Overview
This document tracks all STMBK parameter sweep experiments.
...
""".format(datetime.date.today().isoformat())
    ...
    with open("STMBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: STMBK_experiments.md")
...
echo "Submitting {} STMBK experiments..."
echo ""
