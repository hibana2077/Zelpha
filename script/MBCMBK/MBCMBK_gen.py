#!/usr/bin/env python3
"""
Generate PBS job scripts for MBCMBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: MBCMBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# MBCMBK Parameter Sweep Experiments
...
""".format(datetime.date.today().isoformat())
    ...
    with open("MBCMBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: MBCMBK_experiments.md")
...
echo "Submitting {} MBCMBK experiments..."
echo ""
