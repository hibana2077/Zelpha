#!/usr/bin/env python3
"""
Generate PBS job scripts for MBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: MBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# MBK Parameter Sweep Experiments
...
""".format(len(experiments))
    ...
    for exp in experiments:
        md_content += "| {} | {} | {} | {} | {} | {} | TBD | TBD | TBD | TBD | TBD |\n".format(
            exp['id'],
            exp['num_prototypes'],
            exp['beta'],
            exp['margin'],
...
""".format(datetime.date.today().isoformat())
    ...
    with open("MBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: MBK_experiments.md")
...
echo "Submitting {} MBK experiments..."
echo ""
