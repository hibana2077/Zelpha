#!/usr/bin/env python3
"""
Generate PBS job scripts for CNMBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: CNMBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# CNMBK Parameter Sweep Experiments
...
""".format(datetime.date.today().isoformat())
    ...
    with open("CNMBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: CNMBK_experiments.md")
...
echo "Submitting {} CNMBK experiments..."
echo ""
