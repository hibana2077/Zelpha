#!/usr/bin/env python3
"""
Generate PBS job scripts for DMBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: DMBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# DMBK Parameter Sweep Experiments
...
""".format(datetime.date.today().isoformat())
    ...
    with open("DMBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: DMBK_experiments.md")
...
echo "Submitting {} DMBK experiments..."
echo ""
