#!/usr/bin/env python3
"""
Generate PBS job scripts for D121MBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: D121MBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# D121MBK Parameter Sweep Experiments
...
""".format(datetime.date.today().isoformat())
    ...
    with open("D121MBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: D121MBK_experiments.md")
...
echo "Submitting {} D121MBK experiments..."
echo ""
