#!/usr/bin/env python3
"""
Generate PBS job scripts for RGNMBK parameter sweep.
...
python3 src/train.py \\
    --model_name regnetz_c16_evos.ch_in1k \\
...
def generate_scripts():
    ...
    print(f"Markdown documentation: RGNMBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# RGNMBK Parameter Sweep Experiments
...
""".format(datetime.date.today().isoformat())
    ...
    with open("RGNMBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: RGNMBK_experiments.md")
...
echo "Submitting {} RGNMBK experiments..."
echo ""
