#!/usr/bin/env python3
"""
Generate PBS job scripts for HL26MBK parameter sweep.
...
def generate_scripts():
    ...
    print(f"Markdown documentation: HL26MBK_experiments.md")
...
def generate_markdown(experiments):
    ...
    md_content = """# HL26MBK Parameter Sweep Experiments

## Overview
This document tracks all HL26MBK parameter sweep experiments.
...
""".format(datetime.date.today().isoformat())
    ...
    with open("HL26MBK_experiments.md", 'w', encoding='utf-8') as f:
        f.write(md_content)
    
    print("Generated: HL26MBK_experiments.md")
...
echo "Submitting {} HL26MBK experiments..."
echo ""
